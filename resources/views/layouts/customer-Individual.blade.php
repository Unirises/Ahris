                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                              <div class="form-group">
                                                ...
                                                <input type="number" name="credit_limit" value="{{$contact['tax']->credit_limit_account}}" class="form-control" id="example2cols2Input" placeholder="0.00">  </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                              ...
                                              <div class="col-md-3">
                                                {{-- <div class="form-group">
                                                    ...
                                                    <select class="form-control select2-hidden-accessible" data-toggle="select" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                        ...
                                                        <option data-select2-id="4">Do not block sending invoices past credit limit</option>
                                                    </select>
                                                </div> --}}
                                              </div>
                                          </div>
