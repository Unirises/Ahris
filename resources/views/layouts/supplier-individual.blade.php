    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <div class="form-group">
          ...
          <input type="text" name="firstname" class="form-control" id="example3cols1Input" value="{{$contacts[0]['firstname']}}">
        </div>
      </div>
      <div class="col-md-3">
          <div class="form-group">
            <label class="form-control-label" for="example3cols1Input">Last Name</label>
            <input type="text" name="lastname" class="form-control" id="example3cols1Input" value="{{$contacts[0]['lastname']}}">
          </div>
        </div>
      <div class="col-md-6">
        <div class="form-group">
      ...
      <div class="col-md-2">
        ...
        <div class="col-md-2">
          <div class="form-group">
            ...
            <input type="text"  name="email_add_person" class="form-control" value="{{$contact['person']->email}}" id="example2cols2Input" placeholder="Separate multiple emails with commas">
          </div>
        </div>
    </div>
    {{-- <div class="row">
  ...
  <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="number" value="{{$contact['tax']->credit_limit_account}}" name="credit_limit" class="form-control" id="example2cols2Input" placeholder="0.00"> </div>
      </div>
      <div class="col-md-3">
          <div class="form-group">
